...
<p>
    <a href="#" class="reply">subject</a> 
    <a href="#" class="reply">subject_organization</a> 
    <a href="#" class="reply">subject_PlaceNam</a>
...
<div class="row  p-4">    
<ul class="list-inline">
<li><span class="icon-calendar-check-o"></span> Архів створено: <strong><?= $model->DateArchived?></strong></li>    
</ul>    
 </div>  
