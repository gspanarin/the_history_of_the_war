...
class m240406_134340_CreateTableArticle extends Migration{
    ...
    public function safeUp(){
        $this->createTable('{{%article}}', [
            ...
            'view' => $this->integer()->defaultValue(0)->comment('Кількість переглядів'),
            'share' => $this->integer()->defaultValue(0)->comment('Кількість перепостів'),
            'average_score' => $this->integer()->defaultValue(0)->comment('Середня оцінка'),
